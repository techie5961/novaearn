...
<img style="box-shadow:0 0 10px rgba(0,0,0,0.1)" src="{{ asset('banners/'.$banner_settings->earning_structure.'') }}" alt="Earning Structure Banner" class="w-full m-x-auto box-shadow max-w-500 br-10">
 ...
 <div style="box-shadow:0 0 10px rgba(0,0,0,0.1)" class="w-full navs row p-10 br-10 g-10 bg-light">
    {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/deposit') }}')" style="min-height=100% !important;max-width:25% !important;background: linear-gradient(to bottom right,#4caf50,green);color:white" class="w-full nav h-full p-5 br-10 column g-10 justify-center align-center">
     ...
     {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/withdraw') }}')" style="min-height=100% !important;max-width:25% !important;background: linear-gradient(to bottom right,rgb(108,92,230),rgb(64, 53, 145));color:white" class="w-full h-full nav p-5 br-10 column g-10 justify-center align-center">
        <div style="background:rgba(255,255,255,0.2);color:white;" class="circle p-10 perfect-square column justify-center">
      ...
      {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/products') }}')" style="min-height=100% !important;max-width:25% !important;background: linear-gradient(to bottom right,gold,goldenrod);color:white" class="w-full nav h-full p-5 br-10 column g-10 justify-center align-center">
        <div style="background:rgba(255,255,255,0.2);color:white;" class="circle p-10 perfect-square column justify-center">
      ...
      {{-- NAV --}}
    <div onclick="spa(event,'{{ url('users/gift/code') }}')" style="min-height=100% !important;max-width:25% !important;background: linear-gradient(to bottom right,coral,red);color:white" class="w-full nav h-full p-5 br-10 column g-10 justify-center align-center">
        <div style="background:rgba(255,255,255,0.2);color:white;" class="circle p-10 perfect-square column justify-center">
...
<strong class="desc">Our Investment Products</strong>
    ...
    {{-- PRODUCT --}}
        ...
        <div onclick="MyFunc.ShowSlideUp('{{ $data->name }}','&#8358;{{ number_format($data->price,2) }}','{{ url('users/get/purchase/product/confirm?id='.$data->id.'') }}')" style="box-shadow:0 0 2px var(--primary);background:linear-gradient(to right,var(--primary-dark),var(--primary))" class="w-full font-1 pointer br-10 p-10 bg-primary primary-text column justify-center align-center">
            Add to Portfolio
        </div>
        </div>
    @endforeach
